...
const Intro = () => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="flex flex-col justify-center mb-0 w-full text-center md:text-left pt-28 md:pt-36 min-h-[100vh]  bg-gradient-to-r from-indigo-400 to-cyan-400"
    >
      <div className="flex flex-col md:flex-row">
        <div className="flex px-3 md:px-0 md:pl-14 items-center justify-center md:flex-[1] md:h-[300px] md:w-[300px]">
          <motion.div
        ...
        <div className="flex flex-col flex-[2]">
          <motion.div
            className="flex flex-col mb-10 mt-4 px-4 text-lg md:text-xl  lg:text-2xl font-light !leading-[2.2]"
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
          >
            <h1>HI, I&apos;M FATHIMA RIZMIYA</h1>

            <h1 className="text-2xl md:text-3xl lg:text-5xl font-extrabold tracking-wider">
              <Typewriter
            ...
            <h1 className="sm:text-xl sm:mt-3 sm:mb-16">
              Melbourne, Australia
            </h1>
          </motion.div>

          <motion.div
            className="flex flex-row items-center justify-center md:justify-start md:ml-1 gap-4 px-4 text-lg font-medium"
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{
              delay: 0.1,
